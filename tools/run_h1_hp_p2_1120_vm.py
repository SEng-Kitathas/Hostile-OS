...
def main()->int:
    ...
    ap.add_argument('--rebuild',action='store_true',help='rebuild current d64_reference_v3 before launch')
    ...
    checks={
      ...
      'current_v3_core_trace_present':'TEST=D64_V2_CORE' in trace,
    ...
    receipt={
      'format':'HOSTILE_OS_H1_VM_RUN_V2','status':status,'passed':all(checks.values()),'checks':checks,
