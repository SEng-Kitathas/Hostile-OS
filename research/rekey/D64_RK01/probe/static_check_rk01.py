...
def main():
 ...
 c['reject_branch_no_namespace_mutation']=bool("movb $'R',%al" in reject and 'ret' in reject and all(f not in reject for f in FIELDS) and 'activity_epoch' not in reject and 'completion_status' not in reject and 'backing_live' not in reject and 'relation_active' not in reject)
