...
def main():
 if len(sys.argv)!=2: print('usage: launch_p14.py RUN_ID',file=sys.stderr); return 64
 ...
 mechanism=src/'mechanism.S'; fixture=src/'fixture.S'; linker=src/'linker.ld'; evaluator=src/'evaluate_p14.py'; launcher=Path(__file__).resolve()
