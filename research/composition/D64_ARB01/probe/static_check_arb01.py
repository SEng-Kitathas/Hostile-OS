...
def main()->int:
 ...
 c['ordinary_rb02_paths_reused']=bool(t.count('\nbinding_detach:\n')==1 and t.count('\nbinding_read:\n')==1 and t.count('\nresource_read:\n')==1 and 'call binding_detach' in t.split('_start:',1)[1].split('fail:',1)[0] and 'call binding_read' in t.split('_start:',1)[1].split('fail:',1)[0] and 'call resource_read' in t.split('_start:',1)[1].split('fail:',1)[0])
