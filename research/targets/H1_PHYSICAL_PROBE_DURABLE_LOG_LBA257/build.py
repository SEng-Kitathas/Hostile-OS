...
FLOPPY_BYTES=1474560; PROBE_LBA=9; LOG_BASE_LBA=257; LOG_SECTORS=128; LOG_BYTES=LOG_SECTORS*512
...
def main():
 ...
 sources=['H1_DURABLE_LOG_LBA257_PREREGISTRATION_2026-08-31.md','wrapper_stage1.S','wrapper_stage1.ld','text_loader.S','text_loader.ld','stage2.S','stage2.ld','build.py','verify_static.py','extract_log.py','run_qemu_qualification.py']
