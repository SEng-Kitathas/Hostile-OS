...
$image=Join-Path $root 'research\targets\H1_BIOS_USB_READ_DISCRIMINATOR\build_segment_encoding\h1_bios_usb_read_segment_encoding_1MiB.img'
$outDir=Join-Path $root 'research\targets\H1_BIOS_USB_READ_DISCRIMINATOR\physical_runs\20260831_h1_read5_01_prep'
New-Item -ItemType Directory -Force -Path $outDir | Out-Null
$expected='d097e68f47c1f4d7d8274b73d00e11ddadce7318aa4e334edfe464b9a515e91f'
...
Write-Host "PASS read5 discriminator written and verified $rh"
