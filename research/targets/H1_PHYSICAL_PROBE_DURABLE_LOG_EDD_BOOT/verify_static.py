...
LOG_BASE=257; LOG_SECTORS=128; SECTOR=512
...
def main():
 ...
 checks={
  ...
  'stage1_trace_and_edd_loader_calls_exact': s1_calls==['0x41','0x42','0x41','0x43'],
  ...
  'loader_trace_and_logger_functions_exact': loader_calls.count('0x41')==2 and loader_calls.count('0x43')==2 and loader_calls.count('0x08')==1 and loader_calls.count('0x42')==1 and loader_calls.count('0x02')==1 and loader_calls.count('0x03')==1,
  'loader_no_other_disk_write_functions': not re.search(r'movb \$(0x05|0x06|0x07),%ah',loader,re.I),
  'trace_stage1_lba257_only': '.equ TRACE_LBA,257' in s1 and '.long TRACE_LBA' in s1 and 'H1TRACE_STAGE1_ENTER' in s1 and 'H1TRACE_STAGE1_LOADED' in s1,
  'trace_loader_lba257_only': '.long 257' in loader and 'H1TRACE_LOADER_ENTER' in loader,
  'journal_bounds_constants': '.equ LOG_BASE_LBA,257' in loader and '.equ LOG_SECTORS,128' in loader and 'cmpw $LOG_SECTORS,%ax' in loader and 'addl $LOG_BASE_LBA,%eax' in loader,
